        ...
        <div className='flex w-full h-full flex-col'>
          ...
          <div className="content flex flex-col md:flex-row w-full h-full">
              <div className="first h-full w-full flex items-center justify-center relative">
                <img src="resdemo.png" className='heroimage object-contain z-[3] md:h-[500px] h-[232px] absolute rounded-md hover:scale-104 transition-transform' />
              </div>
              ...
              <div className="second flex flex-col items-center md:items-start justify-center h-full w-full">
                  <div className='flex flex-col items-center md:items-start gap-[50px]'>
                    ...
                    <Link to="/create" className='text-[30px] mt-[-20px] md:mt-0 text-center text-white px-4 font-bold cursor-pointer hover:scale-104 transition-transform bg-sky-600 w-[235px] h-[65px] flex items-center justify-center rounded-[10px]'>GET STARTED</Link>
                  </div>
                </div>
            </div>
        </div>
